...
{
	//this is the new function which checks if a string is an integer or not
	...
	public static void main(String[] args) throws IOException 
	{
        ...
        while (runProgram)
        {
        	...
        	while (true)
        	{
        		...
        		//new method which checks if its an integer
        		isInt = isStringInt(userInput);
        		
        		
        		if(!isInt)
        		{
        			//if input is not an int loop again
        			continue;
        		}
        		//if number is an int assign to numin and break out of the while loop
        		numIn = Integer.parseInt(userInput);
    			break;
