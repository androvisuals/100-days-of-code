...
{ 
   ...
   { 
	  ...
	  //the main screen all children get added to this
	  BorderPane bPane = new BorderPane();
	  
	  //main screen
	  GridPane center = new Gui().drawScreen();
	
	  bPane.setCenter(center);
	  
	  //text are section all drawn on the bottom
	  GridPane bottom = new Gui().drawTextArea();
      ...
      scene.setFill(Color.rgb(170, 0, 0));  
